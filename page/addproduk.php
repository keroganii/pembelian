            ...
            <form class="form-horizontal" method="POST" action="<?php echo $link ?>" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-2">
                            <input <?php echo $s ?> value='<?php echo $stok ?>'  name="stok" class="form-control" min="0" required>
                        </div>
                    </div>
                        <?php if($_SESSION['status']=='admin'){ ?>
                    <div class="form-group">
                ...
                <fieldset class="content-group">
                    <div class="form-group">
                        ...
                        ?>
                            <option value="<?php echo $row['id_bahan'] ?>" <?php if($row['id_bahan']==$kain){echo "Selected";} ?>><?php echo $row['nama_bahan'] ?></option>
                        <?php }?>
                            </select>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <option value="0" disabled selected>Pilih bahan</option>
                            ...
                            while($row=mysqli_fetch_array($sql)){
                        ?>
                            <option value="<?php echo $row['id_bahan'] ?>" <?php if($row['id_bahan']==$zipper){echo "Selected";} ?>><?php echo $row['nama_bahan'] ?></option>
                        <?php }?>
                            </select>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <option value="0" disabled selected>Pilih bahan</option>
                            ...
                            while($row=mysqli_fetch_array($sql)){
                        ?>
                            <option value="<?php echo $row['id_bahan'];?> " <?php if($row['id_bahan']==$foam){echo "Selected";} ?>><?php echo $row['nama_bahan'] ?></option>
                        <?php }?>
                            </select>
                        </div>
                    </div>
