...
// if everything is ok, try to upload file
    ...
    $sql=mysqli_query($conn,"INSERT into produk values('$_POST[id]','$_POST[nama]','$_POST[ukuran]','$_POST[harga]','$_POST[stok]','$_POST[ket]',
    '$nfile','$_POST[kain]','$_POST[zipper]','$_POST[foam]','$_POST[hari]')");
    if($sql){
