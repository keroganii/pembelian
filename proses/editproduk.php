...
if(empty($_FILES['fileimages']['tmp_name'])){
    ...
    $sql=mysqli_query($conn,"UPDATE produk SET nama_produk='$name', harga='$harga', ukuran='$ukuran',stok='$stok',
    keterangan='$ket',bahan_kain='$_POST[kain]',bahan_zipper='$_POST[zipper]',bahan_foam='$_POST[foam]',waktu_produksi='$_POST[hari]' where id_produk='$id'");
    if($sql){
